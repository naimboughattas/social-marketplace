...
interface CommentOptionsStepProps {
...
export default function CommentOptionsStep({
  commentType,
  onCommentTypeChange,
  commentText,
  onCommentTextChange,
...
}: CommentOptionsStepProps) {
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-medium mb-4">Options de commentaire</h3>
