      ...
      {isCampaign ? (
        <div className="bg-blue-50 p-4 rounded-lg">
          ...
          <ul className="space-y-2 text-sm text-blue-700">
            <li>• Publiée et visible par les influenceurs correspondant à vos critères</li>
            <li>• Disponible selon le principe du premier arrivé, premier servi</li>
            <li>• Active jusqu'à ce que le nombre d'influenceurs souhaité soit atteint</li>
            <li>• Facturée uniquement pour les interactions effectivement réalisées</li>
          </ul>
        </div>
      ) : (
        <div className="bg-blue-50 p-4 rounded-lg">
